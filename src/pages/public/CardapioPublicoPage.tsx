            ...
            <div className="space-y-2 text-white/90">
              ...
              {empresa?.whatsapp && (
                <button
                  ...
                  className="flex items-center justify-center gap-2 text-sm md:text-base bg-green-600/20 hover:bg-green-600/30 backdrop-blur-sm border border-green-400/30 rounded-lg px-4 py-2 transition-all duration-300 hover:scale-105 group"
                >
                  ...
                  <span className="text-white/90 group-hover:text-white transition-colors font-medium">{empresa.whatsapp}</span>
                </button>
              )}
            </div>
          </div>
