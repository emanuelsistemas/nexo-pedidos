-- =====================================================
-- SCRIPT ESTENDIDO PARA POPULAR MAIS NCM NO SUPABASE
-- =====================================================
-- Execute APÓS o script populate_ncm_supabase.sql
-- Adiciona mais NCM comuns para uma base mais completa
-- =====================================================

-- INSERIR MAIS NCM COMUNS (SEM CEST - SEM SUBSTITUIÇÃO TRIBUTÁRIA)
INSERT INTO ncm (codigo_ncm, descricao_ncm, tem_substituicao_tributaria, unidade_medida, observacoes) VALUES
-- ALIMENTOS BÁSICOS
...
-- =====================================================
-- SCRIPT ESTENDIDO CONCLUÍDO!
-- =====================================================
-- ✅ Adicionados mais NCM comuns sem substituição tributária
-- ✅ Cobertura ampliada para diversos segmentos
