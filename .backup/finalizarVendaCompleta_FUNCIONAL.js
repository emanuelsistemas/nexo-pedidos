// ✅ BACKUP DA FUNÇÃO finalizarVendaCompleta FUNCIONAL
// Extraída do commit: d6797d075756ff67a0d01c1325999bfd3ff2423d
// Data: 25/07/2025 23:30
// Status: FUNCIONA NORMALMENTE (sem problemas de baixa de insumos)
...
const finalizarVendaCompleta = async (tipoFinalizacao: string = 'finalizar_sem_impressao') => {
  ...
  try {
    ...
    // CONTINUA... (Esta é apenas a primeira parte do backup)
    // A função completa tem mais ~1000 linhas
  };
